...
"""
mainThread = threading.Thread(target = root.mainloop(), args = (None,))
closingThread = threading.Thread(target = prog.Popen(['pwershell', 'stop-process -name "cmd" -force']), args = (None,))
